...
// 
//  1. BEZPIECZE�STWO TYP�W (Type Safety):
//  2. UNIKANIE KONFLIKTU NAZW (Name Collisions):
//  3. CZYSTO�� ARCHITEKTURY (Modern C++ Standard):
//==========================================================================================================
...
//==============================POSITION============================================================
enum Piece : uint8_t { //s� r�wnoznacze z indexami w bitboard
...
enum CastlingRights : uint8_t {//flagi prawa do roszad
    WK = 1,  // 0001: White Kingside (Kr�tka Bia�e)
    WQ = 2,  // 0010: White Queenside (D�uga Bia�e)
    BK = 4,  // 0100: Black Kingside (Kr�tka Czarne)
