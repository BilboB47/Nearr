...
constexpr int mg_pawn_table[64] = {
      0,   0,   0,   0,   0,   0,   0,   0, // Linia 1 (a1-h1)
    -35,  -1, -20, -23, -15,  24,  38, -22, // Linia 2
    -26,  -4,  -4, -10,   3,   3,  33, -12, // Linia 3
    -27,  -2,  -5,  12,  17,   6,  10, -25, // Linia 4
    -14,  13,   6,  21,  23,  12,  17, -23, // Linia 5
     -6,   7,  26,  31,  65,  56,  25, -20, // Linia 6
     98, 134,  61,  95,  68, 126,  34, -11, // Linia 7
      0,   0,   0,   0,   0,   0,   0,   0  // Linia 8 (a8-h8)
};
...
double tapered_eval(const Position& pos);//w jakim stopniu do mid-end game
